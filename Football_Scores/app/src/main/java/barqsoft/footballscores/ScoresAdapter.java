...
public class ScoresAdapter extends CursorAdapter
{
    ...
    private String FOOTBALL_SCORES_HASHTAG = mContext.getResources().getString(R.string.hashtag);
    ...
    public void bindView(View view, final Context context, Cursor cursor)
    {
        ...
        mHolder.score.setContentDescription(Utilies.getContentScores(cursor.getInt(COL_HOME_GOALS), cursor.getInt(COL_AWAY_GOALS)));
        mHolder.match_id = cursor.getDouble(COL_ID);
        mHolder.home_crest.setImageResource(Utilies.getTeamCrestByTeamName(context, cursor.getString(COL_HOME)));
        mHolder.home_crest.setContentDescription(cursor.getString(COL_HOME));
        mHolder.away_crest.setImageResource(Utilies.getTeamCrestByTeamName(context, cursor.getString(COL_AWAY)));
